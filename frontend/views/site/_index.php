...
<div class="site-index">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="card mb-3 mt-0 border-0">
                <div class="card-body">
                    <h4 class="card-title"><?= $title['event_name'] ?></h4>
                    <p class="card-text">This questionaire aims to solicit your honest assessment of our S&T intervention services.
                        Please take a minute in filling out this form and help us serve you better. </p>
                    <div class="form-group form-email required">
                        <label for="txtEmail"><b>Email</b> (<span class="text-danger">Required</span>)</label>
                    ...
                    <div class="form-group form-name reruired">
                        <label for="txtName"><b>Name</b> (<span class="text-danger">Required</span>)</label>
            ...
            <?php foreach ($groups as $group) { ?>
                ...
                $sql1 = 'SELECT a.`event_id`,
                            ...
                            INNER JOIN tbl_question AS c ON c.`question_group_id` = b.`question_group_id`
                            WHERE a.`event_id` =' . base64_decode(base64_decode($_GET['id'])) . ' AND c.`question_group_id`=' . $group['question_group_id'];
                try {
                ...
                <div class="card mb-3 border-0">
                    <div class="card-header">
                        <b><?= $group['question_group_name'] ?></b> (<span class="text-danger">Required</span>)
                    </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-center question-description">
                                        ...
                                        <input type="hidden" id="custId" name="questionId[<?= $group['question_group_id'] ?>][<?= $q ?>]" value="<?= base64_encode(base64_encode($question['question_id'])) ?>">
                                        <input type="hidden" id="groupId" name="groupId[<?= $group['question_group_id'] ?>][<?= $q ?>]" value="<?= base64_encode(base64_encode($group['question_group_id'])) ?>">
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center">

                                        <div class="checkboxgroup">
                                            <input type="radio" name="<?= 'rating[' . $group['question_group_id'] . '][' . $q . ']' ?>" value="5" class="smiley5" id="radio1" required>
                                            <label for="radio1"><b>Outstanding</b></label>
                                        </div>
                                        <div class="checkboxgroup">
                                            <input type="radio" name="<?= 'rating[' . $group['question_group_id'] . '][' . $q . ']' ?>" value="4" class="smiley4" id="radio2" required>
                                            <label for="radio2"><b>Very Satisfactory</b></label>
                                        </div>
                                        <div class="checkboxgroup">
                                            <input type="radio" name="<?= 'rating[' . $group['question_group_id'] . '][' . $q . ']' ?>" value="3" class="smiley3" id="radio3" required>
                                            <label for="radio3"><b>Satisfactory</b></label>
                                        </div>
                                        <div class="checkboxgroup">
                                            <input type="radio" name="<?= 'rating[' . $group['question_group_id'] . '][' . $q . ']' ?>" value="2" class="smiley2" id="radio4" required>
                                            <label for="radio4"><b>Unsatisfactory</b></label>
                                        </div>
                                        <div class="checkboxgroup">
                                            <input type="radio" name="<?= 'rating[' . $group['question_group_id'] . '][' . $q . ']' ?>" value="1" class="smiley1" id="radio5" required>
